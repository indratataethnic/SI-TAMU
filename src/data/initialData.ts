...
export const initialRewards: RewardRecord[] = [
  ...
  },
  {
    ...
    points: 3,
    date: '2026-08-22',
    competitionName: 'Lomba Pidato Bahasa Indonesia FLS2N',
  ...
  },
  {
    ...
    points: 6,
    date: '2026-08-26',
    competitionName: 'Kejuaraan Karate Pelajar Se-Jawa Barat',
    organizer: 'FORKI Provinsi',
    certificateNumber: 'FORKI/KATA/JBR/118',
    reporterName: 'Pak Hendra, S.Pd.',
    notes: 'Kategori Kata Perorangan Putri Tingkat SMP.',
    whatsappSent: true,
...
export const initialSettings: SchoolSettings = {
  ...
  schoolEmail: 'info@smpn1teladan.sch.id',
  schoolWebsite: 'https://smpn1teladan.sch.id',
  ...
  waGatewayApiKey: '',
  waGatewayDevice: '',
  letterNumberPrefix: '421.3/ST/SI-TAMU'
};
